  ...
  <fragment>
    <div :class="[$style.sectionContent]">
      <div :class="[$style.sectionInner]">
        <div :class="[$style.sectionInfo]">
          <span :class="[$style.filledSectionIcon]">
            <font-awesome-icon
    ...
    >
      <div
        ...
        :key="index"
      >
        <div :class="[$style.filledCard]" v-if="solution.id === 1">
          <img
            :src="solution.avatar"
